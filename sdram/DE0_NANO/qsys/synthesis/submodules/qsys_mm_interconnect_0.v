...
module qsys_mm_interconnect_0 (
		...
		input  wire [7:0]  sdram_write_avalon_master_byteenable,                     //                                                   .byteenable
		input  wire        sdram_write_avalon_master_write,                          //                                                   .write
		input  wire [63:0] sdram_write_avalon_master_writedata,                      //                                                   .writedata
	...
	wire  [138:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> sdram_read_avalon_master_agent:rp_data
	...
	wire   [63:0] sdram_write_avalon_master_translator_avalon_universal_master_0_readdata;      // sdram_write_avalon_master_agent:av_readdata -> sdram_write_avalon_master_translator:uav_readdata
	...
	wire    [7:0] sdram_write_avalon_master_translator_avalon_universal_master_0_byteenable;    // sdram_write_avalon_master_translator:uav_byteenable -> sdram_write_avalon_master_agent:av_byteenable
	...
	wire   [63:0] sdram_write_avalon_master_translator_avalon_universal_master_0_writedata;     // sdram_write_avalon_master_translator:uav_writedata -> sdram_write_avalon_master_agent:av_writedata
	wire    [3:0] sdram_write_avalon_master_translator_avalon_universal_master_0_burstcount;    // sdram_write_avalon_master_translator:uav_burstcount -> sdram_write_avalon_master_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                        // rsp_mux_001:src_valid -> sdram_write_avalon_master_agent:rp_valid
	wire  [138:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> sdram_write_avalon_master_agent:rp_data
	...
	wire  [138:0] router_src_data;                                                              // router:src_data -> cmd_demux:sink_data
	...
	wire  [138:0] sdram_write_avalon_master_agent_cp_data;                                      // sdram_write_avalon_master_agent:cp_data -> router_001:sink_data
	...
	wire  [138:0] router_001_src_data;                                                          // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [138:0] cmd_demux_src0_data;                                                          // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [138:0] cmd_demux_001_src0_data;                                                      // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [138:0] rsp_demux_src0_data;                                                          // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [138:0] rsp_demux_src1_data;                                                          // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire   [84:0] router_002_src_data;                                                          // router_002:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [138:0] sdram_s1_rsp_width_adapter_src_data;                                          // sdram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [138:0] cmd_mux_src_data;                                                             // cmd_mux:src_data -> sdram_s1_cmd_width_adapter:in_data
