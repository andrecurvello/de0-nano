...
module system_mm_interconnect_0 (
		...
		input  wire        clk_sdram_clk_clk,                                        //                                      clk_sdram_clk.clk
	...
	wire  [24:0] sdram_read_avalon_master_translator_avalon_universal_master_0_address;       // sdram_read_avalon_master_translator:uav_address -> sdram_read_avalon_master_agent:av_address
	...
	wire  [75:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> sdram_read_avalon_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                           // sdram_read_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> sdram_read_avalon_master_agent:rp_channel
	...
	wire  [76:0] sdram_s1_agent_rf_source_data;                                               // sdram_s1_agent:rf_source_data -> sdram_s1_agent_rsp_fifo:in_data
	...
	wire  [76:0] sdram_s1_agent_rsp_fifo_out_data;                                            // sdram_s1_agent_rsp_fifo:out_data -> sdram_s1_agent:rf_sink_data
	...
	wire  [75:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> sdram_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // sdram_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [0:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [75:0] sdram_read_avalon_master_agent_cp_data;                                      // sdram_read_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [75:0] router_src_data;                                                             // router:src_data -> cmd_demux:sink_data
	...
	wire  [75:0] sdram_s1_agent_rp_data;                                                      // sdram_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [75:0] cmd_demux_src0_data;                                                         // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [75:0] crosser_out_data;                                                            // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [75:0] rsp_demux_src0_data;                                                         // rsp_demux:src0_data -> crosser_001:in_data
	...
	wire  [75:0] crosser_001_out_data;                                                        // crosser_001:out_data -> rsp_mux:sink0_data
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (sdram_read_clock_reset_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
		.out_clk           (clk_sdram_clk_clk),                                        //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (clk_sdram_clk_clk),                                        //        in_clk.clk
		.in_reset          (sdram_reset_reset_bridge_in_reset_reset),                  //  in_clk_reset.reset
		.out_clk           (clk_clk_clk),                                              //       out_clk.clk
		.out_reset         (sdram_read_clock_reset_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_sdram_clk_clk),                       // in_clk_0.clk
